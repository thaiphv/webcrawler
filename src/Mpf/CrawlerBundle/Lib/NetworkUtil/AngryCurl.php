...
namespace Mpf\CrawlerBundle\Lib\NetworkUtil;
...
class AngryCurl extends RollingCurl {
    ...
    protected static $request_count = 0;
    ...
    public function request($url, $method = "GET", $post_data = null, $headers = null, $options = null)
    {
        ...
        {
            $options[CURLOPT_PROXY]=$this->array_proxy[ self::$request_count++ % $this->n_proxy ];
    ...
    protected function filter_alive_proxy($window_size = 5)
    {
        ...
        $this->__set('callback', __NAMESPACE__ . '\AngryCurl::callback_proxy_check');
